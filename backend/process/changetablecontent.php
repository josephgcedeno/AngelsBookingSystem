<?php
	...
	else if ($_POST['client_status']=='cancel') 
	{
	  
   		$gfdb->makeDataFromDatabaseToJasonFormatForTable("SELECT *  FROM pm_client WHERE client_status='cancel' ", $_SESSION['cols'], 9, "../js/value.json");
